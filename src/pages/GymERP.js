...
import GymStudio3D from '../components/GymStudio3D';
...
export default function GymERP() {
  const [loading, setLoading] = useState(true);
  const [contactName, setContactName] = useState("");
  const [contactInstitution, setContactInstitution] = useState("");

  const handleWhatsApp = () => {
    const message = `Hello Devansh! My name is ${contactName || "[Your Name]"} and I run ${contactInstitution || "[Your Gym/Studio]"}. We are done losing margins to aggregators and want to build our tailored Fitness engine. Let's talk!`;
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="relative min-h-screen bg-transparent text-slate-900 font-sans overflow-x-hidden selection:bg-cyan-400 selection:text-slate-900"
        style={{ pointerEvents: loading ? 'none' : 'auto' }}
      >
        <Helmet>
          <title>Gym & Fitness ERP | Tailored by DWD</title>
          <meta name="description" content="Upgrade your gym. Build a custom membership engine, bypass aggregators, and automate PT sales with DWD." />
        </Helmet>
        ...
        <nav className="fixed top-0 w-full z-40 bg-white/40 backdrop-blur-xl border-b border-white/40">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-center md:justify-end gap-8">
            <a href="#comparison" className="text-sm font-semibold text-slate-600 hover:text-cyan-600 transition-colors">The Trap</a>
            <a href="#pillars" className="text-sm font-semibold text-slate-600 hover:text-cyan-600 transition-colors">The 3 Pillars</a>
            <a href="#contact" className="px-6 py-2.5 bg-slate-900 text-cyan-400 text-sm font-bold rounded-full shadow-lg hover:bg-slate-800 transition-colors">Consultation</a>
          </div>
        </nav>
        ...
        <div className="relative z-10 bg-slate-50 rounded-b-[4rem] shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
          ...
          <section className="relative pt-32 pb-20 px-6 lg:px-8 min-h-screen flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto">
            <div className="md:w-[45%] relative z-10 text-center md:text-left mt-20 md:mt-0" data-cursor="hero" data-cursor-text="SCROLL">
              ...
              >
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-slate-900 mb-6 leading-[1.1]">
                  You built a gym to train clients. <br className="hidden md:block"/>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600">
                    Not to fight aggregators.
                  </span>
                </h1>
                <p className="mt-4 text-lg md:text-xl text-slate-600 max-w-xl font-light leading-relaxed mx-auto md:mx-0">
                  Stop losing margins to 3rd party class-pass platforms. Automate your memberships, check-ins, and PT sales with your own premium digital ecosystem.
                </p>
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                  <a href="#comparison" className="px-8 py-4 bg-slate-900 text-cyan-400 font-bold rounded-full text-base shadow-xl shadow-slate-900/20 hover:scale-105 transition-transform" data-cursor="button">
            ...
            <div className="md:w-[55%] h-[600px] w-full relative z-0 mt-12 md:mt-0 cursor-grab active:cursor-grabbing rounded-[2rem] overflow-hidden border-4 border-slate-900 shadow-2xl bg-[#fafafa]">
               {/* 3D Scene Wrapper */}
                <div className="absolute inset-0 bg-[#050505] overflow-hidden rounded-[2rem] shadow-2xl border border-slate-700">
                  <Suspense fallback={
                    <div className="absolute inset-0 flex items-center justify-center text-cyan-400 font-bold animate-pulse">
                      LOADING FITNESS OS...
                    </div>
                  }>
                    <GymStudio3D />
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-24">
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter">
                  The <span className="text-red-500 line-through decoration-red-600 decoration-[6px]">Aggregator</span> Trap.
                </h2>
                <p className="mt-6 text-xl text-slate-400 font-light max-w-2xl mx-auto">
                  Relying entirely on third-party fitness platforms drains your profits and leaves you blind to your own members.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
                ...
                >
                  ...
                  <ul className="space-y-6">
                    {['You surrender huge margins on every class booking.', 'You have zero brand loyalty; members belong to the platform.', 'Front desk staff get overwhelmed with messy class rosters.', 'Personal training upselling is chaotic and manual.'].map((text, i) => (
                ...
                {/* The DWD Way (Cyan/Black) */}
                <motion.div 
                  initial={{ opacity: 0, x: 30 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.6, delay: 0.2 }}
                  className="border border-cyan-500/30 bg-cyan-900/10 p-10 md:p-14 rounded-3xl relative overflow-hidden group hover:bg-cyan-900/20 transition-colors duration-500 shadow-[0_0_50px_rgba(6,182,212,0.1)]"
                ...
                >
                  ...
                  <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-200 mb-8 uppercase tracking-widest flex items-center gap-3">
                    <span className="w-3 h-3 bg-cyan-400 rounded-full shadow-[0_0_10px_rgba(6,182,212,0.8)]" /> The Fitness Engine
                  </h3>
                  <ul className="space-y-6">
                    {['A custom direct booking portal with 0% commissions.', 'You own the member data for powerful remarketing.', 'Automated gym check-ins via digital tablets or QR.', 'Built-in funnels to seamlessly upsell Personal Training.'].map((text, i) => (
                      <li key={i} className="flex gap-4 text-slate-200 font-medium text-lg border-b border-cyan-500/20 pb-4">
          ...
          <section id="pillars" className="py-32 pb-40 px-6 relative z-10 bg-white rounded-b-[4rem] overflow-hidden">
            <div className="max-w-7xl mx-auto">
              <div className="mb-32 md:text-center">
                <KineticHeading text="The 3 Pillars of Fitness." />
              ...
              <div className="space-y-32">
                ...
                <div className="flex flex-col md:flex-row gap-16 items-center">
                  ...
                  >
                    ...
                    <p className="text-lg text-slate-600 leading-relaxed font-medium">Class aggregators are a necessary evil for discovery, but they shouldn't own your repeat business.</p>
                    <p className="mt-4 text-slate-500 leading-relaxed">We build ultra-fast, high-converting direct membership engines right on your website. Seamless payments, real-time class availability sync, and instant confirmations that feel more premium than third-party apps.</p>
                  </motion.div>
                  <motion.div 
                  ...
                  >
                     ...
                     <div className="relative w-[80%] md:w-72 bg-[#0a0f1c] rounded-3xl shadow-2xl p-8 flex flex-col justify-center border border-cyan-900/30 hover:scale-105 transition-transform duration-500 cursor-pointer">
                        <div className="flex justify-between items-center mb-6">
                          ...
                          <span className="text-xs font-bold text-cyan-400 bg-cyan-900/30 px-3 py-1 rounded-full border border-cyan-500/20">Active</span>
                        </div>
                        <div className="text-slate-400 font-bold mb-1 tracking-wider text-sm uppercase">Pro Membership</div>
                        <div className="text-3xl font-black text-white mb-2">+₹12,500/mo</div>
                        <div className="flex justify-between mt-4 border-t border-slate-800 pt-4">
                           <div className="text-sm font-bold text-slate-400 uppercase tracking-wider">Source: <span className="text-cyan-400">Direct Portal</span></div>
                        </div>
                     </div>
                  </motion.div>
                </div>
                ...
                <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
                  ...
                  >
                    ...
                    <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 leading-tight">Front Desk <br />& Access Control.</h3>
                    <p className="text-lg text-slate-600 leading-relaxed font-medium">Remove friction from your member's arrival.</p>
                    <p className="mt-4 text-slate-500 leading-relaxed">Our unified dashboard connects the front desk directly to member profiles. Check-in takes seconds with digital QR codes or RFID. Track capacity, manage waitlists, and identify churn-risks automatically.</p>
                  </motion.div>
                  <motion.div 
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                  ...
                  >
                     ...
                     <div className="relative w-72 h-64 bg-white rounded-t-3xl shadow-2xl p-6 border-t border-x border-slate-100 hover:-translate-y-4 transition-transform duration-500 cursor-pointer">
                        <div className="space-y-4">
                          {[
                            { name: "John Doe", status: "Checked In", color: "text-green-700 bg-green-100" },
                            { name: "Jane Smith", status: "PT Session", color: "text-amber-700 bg-amber-100" },
                            { name: "Alex Roe", status: "Expired", color: "text-red-700 bg-red-100" }
                          ].map((member, i) => (
                            <div key={i} className="flex items-center justify-between p-3 border border-slate-100 rounded-xl bg-slate-50">
                              ...
                              <span className={`text-xs font-bold px-2 py-1 rounded-full ${member.color}`}>
                                {member.status}
                              </span>
                            </div>
                          ))}
                ...
                <div className="flex flex-col md:flex-row gap-16 items-center">
                  ...
                  >
                    ...
                    <p className="text-lg text-slate-600 leading-relaxed font-medium">Members commit to premium when they perceive premium.</p>
                    <p className="mt-4 text-slate-500 leading-relaxed">We don't just build the backend ERP. We build your front-facing marketing website with stunning 3D gym tours, bespoke typography, and a user experience that makes corporate gym chains envious.</p>
                  </motion.div>
                  <motion.div 
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    ...
                    className="md:w-1/2 w-full h-80 bg-slate-900 rounded-[3rem] border border-slate-800 shadow-inner relative overflow-hidden flex items-center justify-center"
                  >
                     <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800&auto=format&fit=crop')] bg-cover bg-center opacity-40 mix-blend-overlay" />
                     <div className="relative w-32 h-64 bg-black/80 backdrop-blur-md rounded-[2rem] border border-white/10 p-2 hover:scale-105 transition-transform duration-500 cursor-pointer shadow-2xl flex flex-col">
                        <div className="w-full h-1/2 bg-white/5 rounded-xl mb-2 flex items-center justify-center">
                          <div className="w-10 h-10 rounded-full border-2 border-cyan-500/50" />
                        </div>
                        <div className="h-2 w-3/4 bg-white/20 rounded-full mb-1" />
                        <div className="h-1 w-1/2 bg-white/10 rounded-full mb-4" />
                        <div className="mt-auto h-8 bg-cyan-500 rounded-xl flex items-center justify-center">
           ...
           <section id="contact" className="w-full max-w-5xl px-6 relative z-10">
             ...
             <div className="relative z-20">
               ...
               <p className="text-2xl md:text-4xl lg:text-5xl font-bold leading-relaxed lg:leading-snug text-slate-100">
                 ...
                 />
                 <br />
                 We are done losing margins to aggregators. <br /> Let's build our Fitness engine.
               </p>

...
export default function TuitionERP() {
  ...
  return (
    <>
      ...
      >
        <Helmet>
          <title>Tuition & Coaching Classes ERP | Tailored by DWD</title>
          <meta name="description" content="Upgrade your coaching institute. Build a custom student portal and automate batch management with DWD." />
        </Helmet>

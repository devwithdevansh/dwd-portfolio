...
export default function HospitalSoftware() {
  ...
  const handleWhatsApp = () => {
    const message = `Hello Devansh! My name is ${contactName || "[Your Name]"} and I run ${contactHospital || "[Your Hospital]"}. We are done renting generic software and want to build our tailored engine. Let's talk!`;
  ...
  return (
    <>
          ...
          <div className="fixed inset-0 z-[100] flex pointer-events-none">
            {[...Array(5)].map((_, i) => (
              <motion.div
                ...
                animate="animate"
                exit="exit"
                className="w-1/5 bg-emerald-600"
              />
            ))}
          </div>
        )}
      ...
      <motion.div
        ...
        className="relative min-h-screen bg-transparent text-slate-900 font-sans overflow-x-hidden selection:bg-emerald-600 selection:text-white"
        style={{ pointerEvents: loading ? 'none' : 'auto' }}
      >
        <Helmet>
          <title>Hospital ERP & HMIS Software | Tailored by Antigravity</title>
          <meta name="description" content="Build a tailored HMIS engine for your hospital with Antigravity." />
        </Helmet>
        ...
        <nav className="fixed top-0 w-full z-40 bg-white/40 backdrop-blur-xl border-b border-white/40">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-center md:justify-end gap-8">
            <a href="#comparison" className="text-sm font-semibold text-slate-600 hover:text-emerald-600 transition-colors">The Trap</a>
            <a href="#pillars" className="text-sm font-semibold text-slate-600 hover:text-emerald-600 transition-colors">The 3 Pillars</a>
            <a href="#contact" className="px-6 py-2.5 bg-emerald-600 text-white text-sm font-bold rounded-full shadow-lg shadow-emerald-600/30 hover:bg-emerald-700 transition-colors">Consultation</a>
          </div>
        </nav>
        ...
        <div className="relative z-10 bg-slate-50 rounded-b-[4rem] shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
          ...
          <section className="relative pt-32 pb-20 px-6 lg:px-8 min-h-screen flex flex-col md:flex-row items-center justify-center max-w-7xl mx-auto overflow-hidden">
            <div className="md:w-1/2 relative z-10 text-center md:text-left mt-20 md:mt-0" data-cursor="hero" data-cursor-text="SCROLL">
              ...
              >
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-slate-900 mb-6 leading-[1.1]">
                  You built a hospital to heal patients. <br className="hidden md:block"/>
                ...
                <p className="mt-4 text-lg md:text-xl text-slate-600 max-w-xl font-light leading-relaxed mx-auto md:mx-0">
                  You are currently losing revenue to unbilled items and frustrating doctors with clunky UI. Stop renting fragmented generic tools. Build a unified HMIS.
                </p>
            ...
            <div className="md:w-1/2 h-[500px] w-full relative z-0 mt-20 md:mt-0">
              <Suspense fallback={<div className="w-full h-full animate-pulse bg-emerald-100 rounded-full" />}>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-24">
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter">
                  The <span className="text-red-500 line-through decoration-red-600 decoration-[6px]">Generic HMIS</span> Trap.
                </h2>
                <p className="mt-6 text-xl text-gray-400 font-light max-w-2xl mx-auto">
                  Most vendors sell you a boxed subscription with a complex UI that doctors hate. We build fast, tailored engines.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
                ...
                >
                  ...
                  <ul className="space-y-6">
                    <li className="flex gap-4 text-gray-400 font-medium text-lg border-b border-red-900/20 pb-4"><span className="text-red-500 font-black text-xl">×</span> Clunky, 1990s UI that slows down your doctors during critical moments.</li>
                    <li className="flex gap-4 text-gray-400 font-medium text-lg border-b border-red-900/20 pb-4"><span className="text-red-500 font-black text-xl">×</span> Revenue leakage due to unbilled lab tests and fragmented insurance claims.</li>
                    <li className="flex gap-4 text-gray-400 font-medium text-lg border-b border-red-900/20 pb-4"><span className="text-red-500 font-black text-xl">×</span> Your hospital data is hostage to a slow, unresponsive vendor.</li>
                  </ul>
                </motion.div>
                ...
                <motion.div 
                  ...
                  className="border p-10 md:p-14 rounded-3xl relative overflow-hidden group transition-colors duration-500 border-emerald-500/30 bg-emerald-900/10 hover:bg-emerald-900/20 shadow-[0_0_50px_rgba(16,185,129,0.1)]"
                >
                  <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 to-emerald-300" />
                  <h3 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-200 mb-8 uppercase tracking-widest flex items-center gap-3">
                    <span className="w-3 h-3 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.8)]" /> The Tailored Engine
                  </h3>
                  <ul className="space-y-6">
                    <li className="flex gap-4 text-gray-200 font-medium text-lg border-b pb-4 border-emerald-500/20"><span className="text-emerald-400 font-black text-xl">✓</span> Lightning-fast, intuitive UI designed for doctors to prescribe in seconds.</li>
                    <li className="flex gap-4 text-gray-200 font-medium text-lg border-b pb-4 border-emerald-500/20"><span className="text-emerald-400 font-black text-xl">✓</span> Unified revenue cycle management that automatically flags unbilled items.</li>
                    <li className="flex gap-4 text-gray-200 font-medium text-lg border-b pb-4 border-emerald-500/20"><span className="text-emerald-400 font-black text-xl">✓</span> Enterprise-grade, HIPAA-compliant infrastructure built exclusively for you.</li>
                  </ul>
                </motion.div>
              </div>
            </div>
          ...
          <section id="pillars" className="py-32 pb-40 px-6 relative z-10 bg-white rounded-b-[4rem] overflow-hidden">
            <div className="max-w-7xl mx-auto">
              <div className="mb-32 md:text-center">
                <KineticHeading text="The 3 Pillars of Healthcare Ops." />
                <p className="mt-6 text-xl md:text-2xl text-slate-500 font-light max-w-3xl md:mx-auto">
                  We don't just build dashboards. We engineer systems that protect your revenue, clinical time, and patient trust.
                </p>
              </div>
              ...
              <div className="space-y-32">
                ...
                <div className="flex flex-col md:flex-row gap-16 items-center">
                  <motion.div 
                    ...
                    className="md:w-1/2"
                  >
                    <div className="font-bold tracking-widest uppercase mb-4 text-sm flex items-center gap-2 text-emerald-600">
                    ...
                    <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 leading-tight">
                      Billing Integrity & <br />Revenue Protection.
                    </h3>
                    <p className="text-lg text-slate-600 leading-relaxed font-medium">
                      Hospitals lose up to 15% of revenue simply because consumables and tests are performed but never billed.
                    </p>
                    <p className="mt-4 text-slate-500 leading-relaxed">
                      Our tailored engine orchestrates IPD/OPD billing seamlessly. When a lab test is ordered by a doctor, it instantly reflects on the patient's folio. No manual chits. No revenue leakage.
                    </p>
                  </motion.div>
                  <motion.div 
                  ...
                  >
                     ...
                     <div className="relative w-[80%] md:w-72 bg-white rounded-3xl shadow-2xl p-8 flex flex-col justify-center border border-slate-100 hover:scale-105 transition-transform duration-500 cursor-pointer">
                        <div className="flex justify-between items-center mb-6">
                          ...
                          <span className="text-xs font-bold px-3 py-1 rounded-full text-emerald-600 bg-emerald-50">
                            Reconciled
                          </span>
                        </div>
                        <div className="text-4xl font-black text-slate-900 mb-2">₹42,50,000</div>
                        <div className="text-sm font-bold text-slate-400 uppercase tracking-wider">TPA Claims Approved</div>
                     </div>
                  </motion.div>
                </div>
                ...
                <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
                  ...
                  >
                    ...
                    <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 leading-tight">
                      Patient Trust <br />(The Portal).
                    </h3>
                    <p className="text-lg text-slate-600 leading-relaxed font-medium">
                      Patients shouldn't have to wait in line to collect their lab reports or understand their bills.
                    </p>
                    <p className="mt-4 text-slate-500 leading-relaxed">
                      A premium, branded Patient App providing total transparency on prescriptions, discharge summaries, and appointments. When patients experience convenience, they recommend your hospital.
                    </p>
                  </motion.div>
                  <motion.div 
                    initial={{ opacity: 0, scale: 0.9 }}
                ...
                <div className="flex flex-col md:flex-row gap-16 items-center">
                  ...
                  >
                    ...
                    <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 leading-tight">
                      Clinical Sanity <br />(Unified EMR).
                    </h3>
                    <p className="text-lg text-slate-600 leading-relaxed font-medium">
                      Doctors hate using slow software. They resort to handwriting, leading to errors and incomplete digital records.
                    </p>
                    <p className="mt-4 text-slate-500 leading-relaxed">
                      Lightning-fast electronic medical records (EMR). Template-driven prescription workflows that take seconds. Nurses, pharmacy, and doctors reading from one single source of truth.
                    </p>
                  </motion.div>
                  <motion.div 
                    initial={{ opacity: 0, scale: 0.9 }}
                     ...
                     <div className="relative w-[70%] h-[80%] border border-slate-200 rounded-3xl grid grid-cols-2 grid-rows-2 gap-4 p-4 hover:scale-105 transition-transform duration-500 cursor-pointer">
                        {[1,2,3,4].map((i) => (
                          <div key={i} className="bg-white rounded-2xl shadow-sm border border-slate-100 flex items-center justify-center relative overflow-hidden">
                            <div className={`absolute inset-0 opacity-10 ${i % 2 === 0 ? 'bg-orange-500' : 'bg-emerald-500'}`} />
        ...
        <div className="fixed bottom-0 left-0 w-full h-[80vh] z-0 bg-[#050505] text-white flex flex-col items-center justify-center transition-colors duration-700">
           <section id="contact" className="w-full max-w-5xl px-6 relative z-10">
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-[100px] pointer-events-none transition-colors duration-700 bg-emerald-600/10" />
             ...
             <div className="relative z-20">
               ...
               <p className="text-2xl md:text-4xl lg:text-5xl font-bold leading-relaxed lg:leading-snug text-slate-100">
                 ...
                 <input 
                   ...
                   className="bg-transparent border-b-4 border-slate-700 outline-none placeholder-slate-700 w-full md:w-auto md:min-w-[300px] mx-0 md:mx-4 mt-4 md:mt-0 mb-8 md:mb-0 transition-colors duration-500 focus:border-emerald-500 text-emerald-400"
                   data-cursor="hover"
                 />
                 ...
                 <input 
                   ...
                   className="bg-transparent border-b-4 border-slate-700 outline-none placeholder-slate-700 w-full md:w-auto md:min-w-[400px] mx-0 md:mx-4 mt-4 md:mt-0 mb-8 md:mb-0 transition-colors duration-500 focus:border-emerald-500 text-emerald-400"
                   data-cursor="hover"
                 />
                 <br />
                 We are done renting generic software. <br /> 
                 Let's build our tailored engine.
               </p>
               ...
               <div className="mt-16 flex flex-col md:flex-row items-start md:items-center gap-8">
                 ...
                 >
                   ...
                   <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-emerald-500" />
